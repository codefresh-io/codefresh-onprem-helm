...
![Version: 2.10.5](https://img.shields.io/badge/Version-2.10.5-informational?style=flat-square) ![AppVersion: 0.0.0](https://img.shields.io/badge/AppVersion-0.0.0-informational?style=flat-square)
...
| oci://quay.io/codefresh/charts | cfapi-admin(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-sso-group-synchronizer(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-test-reporting(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-kubernetes-endpoints(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-auth(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-internal(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-ws(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-teams(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-endpoints(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-terminators(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-downloadlogmanager(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-buildmanager(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-cacheevictmanager(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-eventsmanagersubscriptions(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-kubernetesresourcemonitor(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-environments(cfapi) | 21.293.11-onprem-1169fc9 |
| oci://quay.io/codefresh/charts | cfapi-gitops-resource-receiver(cfapi) | 21.293.11-onprem-1169fc9 |
...
| oci://quay.io/codefresh/charts | pipeline-manager | 3.143.4-onprem-8582ab7 |
| oci://quay.io/codefresh/charts | postgresql-ha | 12.0.4 |
| oci://quay.io/codefresh/charts | runtime-environment-manager | 3.44.5-onprem-825697e |
