...
| argo-platform.api-graphql.image | object | `{"registry":"us-docker.pkg.dev/codefresh-inc/gcr.io","repository":"codefresh/dev/argo-platform-api-graphql"}` | Image |
| argo-platform.api-graphql.image.registry | string | `"us-docker.pkg.dev/codefresh-inc/gcr.io"` | Registry |
| argo-platform.api-graphql.image.repository | string | `"codefresh/dev/argo-platform-api-graphql"` | Repository |
